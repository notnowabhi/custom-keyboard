...
public class SoftKeyboard extends InputMethodService
    ...
    // defined the initial ArrayList of emojis
    ...
    HashMap<String, String> EmojiMap = new HashMap<String, String>();{{
        ...
        EmojiMap.put("angel", "😇");
        EmojiMap.put("fear", "😱");
        EmojiMap.put("star_struck", "🤩");
        EmojiMap.put("wink_tongue", "😜");
        EmojiMap.put("sleeping", "😴");
        EmojiMap.put("party", "🥳");
        EmojiMap.put("pleading", "🥺");
        EmojiMap.put("zipper_mouth", "🤐");
        EmojiMap.put("monocle", "🧐");
        ...
        EmojiMap.put("apple", "🍎");
        EmojiMap.put("grapes", "🍇");
        EmojiMap.put("champagne", "🍾");
        EmojiMap.put("coffee", "☕");
        EmojiMap.put("trophy", "🏆");
        EmojiMap.put("clapperboard", "🎬");
        EmojiMap.put("music_note", "🎵");
    }}
    ...
    private void commitEmojiToInput(String emoji) {
    ...
    public View onCreateInputView() {
        View inputView = getLayoutInflater().inflate(R.layout.input, null); // Inflate input layout

        mInputView = inputView.findViewById(R.id.keyboard);
        mInputView.setOnKeyboardActionListener(this);
        setLatinKeyboard(mQwertyKeyboard);

        RecyclerView recyclerView = inputView.findViewById(R.id.IdRecyclerView);

        // Initialize the emoji adapter with a click listener
        emojiAdapter = new EmojiAdapter(EmojiList, getLayoutInflater(), new EmojiAdapter.OnEmojiClickListener() {

            @Override
            public void onEmojiClick(String emoji) {
                commitEmojiToInput(emoji); // Commit the emoji to input when clicked
            }
        });
        ...
        return inputView; // Return the inputView instead of mInputView
    }
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        if(inputConnection != null){
            ...
            Log.d(TAG, "onKey: " + currentText);

            if(EmojiMap.containsKey(currentText)){

                if(emojiAdapter != null){
                    emojiAdapter.getEmojiToFront(EmojiMap.get(currentText));
                }else{
                    Log.d(TAG, "onKey: adapter is null" );
                }

            }

        }else{
            Toast.makeText(this, "input connection not found", Toast.LENGTH_SHORT).show();
        }
